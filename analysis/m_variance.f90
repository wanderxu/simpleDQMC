module m_variance
  ...
  contains 
    ...
    subroutine fit(xdata,fdata,error,ares,chsq,f,aerr)
      ...
      call UDVdcmps_R(ndata,nbasis,u,d,v)
      ...
      call InvMatrx_Z(nbasis,v1,vinv,det)
      !!!call inv(v1,vinv,x)
    ...
    subroutine cov_err(xmean, xcov, iseed)
      ...
      call ReSyDiag2(ntau,ntau,xcov,sig_1,uc,ierr)
     ...
     if (sig_1(i).lt.0.d0) then 
         ...
         xmean_1(i) = xmean_1(i) + sqrt(abs(sig_1(i)))*my_gaussian(iseed)
      enddo
      do i = 1,ntau
         x = 0.d0
         do m = 1,ntau
