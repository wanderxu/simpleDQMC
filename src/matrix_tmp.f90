module matrix_tmp
  ...
  subroutine allocate_matrix_tmp
    implicit none
  ...
  end subroutine allocate_matrix_tmp

  subroutine deallocate_matrix_tmp
    implicit none
    deallocate( g0ttmp )   ! 8
    deallocate( gt0tmp )   ! 8
    deallocate( grtmp )   ! 8
  ...
  end subroutine deallocate_matrix_tmp

end module matrix_tmp
